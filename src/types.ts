import type { RequestGenericInterface, FastifyReply, FastifyRequest } from "fastify";
...
export type Request<T = RequestGenericInterface> = FastifyRequest<T, Server, IncomingMessage>;

// Response object extendable with a route interface like defined above
export type Response = FastifyReply<Server, IncomingMessage, ServerResponse, RequestGenericInterface, unknown>;
